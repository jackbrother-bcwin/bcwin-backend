...
import { motoPeriodResponseSchema, periodsRequestSchema } from "@/schemas/moto";

const logger = new Logger("moto-periods");
...
const periodsResponseSchema = z.object({
    ...
    periods: z.array(motoPeriodResponseSchema).openapi({
        description: "List of periods",
    }),
    currentPeriod: motoPeriodResponseSchema.nullable().openapi({
